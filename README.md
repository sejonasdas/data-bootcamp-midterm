...
Darker bands in **2021–2023** indicate a **synchronized national affordability shock**. Metros such as **Glenwood Springs (CO)**, **Steamboat Springs (CO)**, and **Riverside (CA)** remain persistently dark (burdens **>6–7%**), while places like **Milwaukee (WI)** or **Rochester (NY)** show milder or shorter episodes, highlighting local resilience differences arising from supply responsiveness, migration flows, and labor-market composition.
